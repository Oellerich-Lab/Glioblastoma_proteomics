...
rm_vec <- readRDS("20230316_rm_vec.rds")

```

During the analysis of the data, Katharina mentioned that 3 patients were documented as not matching the criteria of inclusion for further analysis. Remove these as well: 

```{r}
rm_vec <- c(rm_vec, "_9_r1_1111", "_9_r1_1129", "_2_r1_2577")
```
...
harmonize_df_parametric <- readRDS("20230215_harmonized.rds") %>%
  dplyr::select(-all_of(c( "_9_r1_1111", "_9_r1_1129", "_2_r1_2577")))
```
...
df_meta <- readRDS("20230215_df_meta_upd.rds") %>%
  filter(prot_id %not_in% c( "_9_r1_1111", "_9_r1_1129", "_2_r1_2577"))
...
#save as csv
write.csv(df_norm_uncorrected, "20230316_gioblastoma_proteome_norm_noBatchCorr.csv")
...
# save as csv
write.csv(df_norm_batch_corrected, "20230316_gioblastoma_proteome_norm_withBatchCorr.csv")
...
#save as csv
write.csv(df_exp, "20230316_glioblastoma_meta_data.csv")
```
